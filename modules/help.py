...
<dl>
  ...
  <dd>- настроить доступ по SSH для пользователя root на компьютеры учеников;</dd>
...
<ul>
  ...
  <li>переименовать компьютеры учеников и учителя, согласно рекомендациям на странице решения;</li>
